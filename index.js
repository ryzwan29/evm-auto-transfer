...
const main = async () => {
  ...
  for (const privateKey of privateKeys) {
    ...
    for (let i = 1; i <= transactionCount; i++) {
      ...
      // Tambahkan delay 3 jam setelah transaksi sukses
      console.log(colors.yellow('⏳ Waiting for 3 hours before the next transaction...'));
      await sleep(3 * 60 * 60 * 1000); // Delay 3 jam
    }
